            ...
            <div className="relative h-full min-h-[600px] rounded-2xl overflow-hidden">
              ...
              <div className="relative h-full flex flex-col justify-center p-12 text-white">
                <h2 className="text-4xl font-bold mb-6">
                  Welcome Back to FarmMitr
                </h2>
                <p className="text-xl opacity-90 mb-8">
                  Continue your smart farming journey with personalized crop recommendations, 
                  weather insights, and expert agricultural guidance.
                </p>
            ...
            <Card className="w-full max-w-md shadow-card">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* Sign In Button */}
                  <Button type="submit" variant="farm" size="lg" className="w-full">
                    Sign In to FarmMitr
                  </Button>
